...
defineModule(sim, list(
  ...
  inputObjects = bind_rows(
    ...
    expectsInput("BECkey", 'data.table', desc = "key that contains the raster ID and corresponding zone/subzone/var of projected BECs",
                 sourceURL = "https://drive.google.com/open?id=1xbYNF-2MzYmFLfGGUWNoyZdK9GnRK3vh"),
    ...
    expectsInput(objectName = "projectedBEC", "rasterStack",
                 ...
                 sourceURL = 'https://drive.google.com/open?id=19xKdc_xCxCAp9xZQ8DZhp3UJ4TC6IQdM'),
    expectsInput(objectName = 'ecoregionMap', "rasterLayer",
